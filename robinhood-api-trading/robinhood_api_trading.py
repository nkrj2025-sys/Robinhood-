...
API_KEY = os.environ.get("ROBINHOOD_API_KEY", "ADD YOUR API KEY HERE")
BASE64_PRIVATE_KEY = os.environ.get("ROBINHOOD_BASE64_PRIVATE_KEY", "ADD YOUR PRIVATE KEY HERE")
